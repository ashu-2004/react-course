...
function Content() {
  const counter = useSelector((store) => store.counter); //It fetches the counter value only when the counter is changed means it increamented or decremented.
  ...
  return (
    <>
      <p className="lead mb-4">Check counter current value: {counter}</p>
    </>
  );
}
